...
fun PacktBottomNavigationBar() {
    val context = LocalContext.current // had to add this context to make the Toast work
    NavigationBar {
        NavigationBarItem(
            ...
            onClick = { /* Handle navigation item click */
                ...
                Toast.makeText(context, "Marta!", Toast.LENGTH_SHORT).show()

                // Q: To make this button take you to another activity, what do you do?
                // (see class notes)
